...
import irec.agents.value_functions.entropy
import irec.agents.value_functions.most_popular
import irec.agents.value_functions.log_pop_ent
...
class WSPBvar(MFValueFunction):
    ...
    def reset(self, observation):
        ...
        items_popularity = value_functions.most_popular.MostPopular.get_items_popularity(
        ...
        self.items_bias = value_functions.log_pop_ent.LogPopEnt.get_items_logpopent(
