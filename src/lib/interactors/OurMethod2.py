...
class OurMethod2(MFInteractor):
    ...
    def train(self,train_dataset):
        ...
        print("WSCB items score correlation:",scipy.stats.pearsonr(items_score,items_popularity),self.train_dataset.num_total_users, self.train_dataset.num_total_items)
        # self.initial_b
