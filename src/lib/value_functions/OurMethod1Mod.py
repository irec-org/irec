...
class OurMethod1Mod(MFValueFunction):
    ...
    def action_estimates(self,candidate_actions):
        ...
        items_score = (1-global_model_weight)*items_user_similarity + global_model_weight*global_model_items_score + self.alpha*items_uncertainty
