...
class OurMethod5(MFValueFunction):
    ...
    def reset(self,observation):
        ...
        self.users_t = defaultdict(lambda: 1)
    ...
    def action_estimates(self,candidate_actions):
        ...
        user_model_items_score = items_user_similarity + self.alpha*np.sqrt(np.log(self.users_t[uid]))*items_uncertainty
