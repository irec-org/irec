...
items_popularity = value_functions.MostPopular.get_items_popularity(
    dsf.matrix_users_ratings, [], normalize=True)
ground_truth = MetricsEvaluator.get_ground_truth(dsf.matrix_users_ratings,
                                                 THRESHOLD)
...
for value in range(0, 51):
    ...
    for j in tqdm(range(len(KS))):
        ...
        me.eval_chunk_metrics(itr.result, ground_truth, items_popularity,
                              items_distance)
