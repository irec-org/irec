...
do
	...
	python3 run.py -b "MovieLens 10M" "Good Books" "Yahoo Music" -m Random MostPopular LinearUCB GLM_UCB OurMethod2 --num_tasks 5 --evaluation_policies_parameters.LimitedInteraction.recommend_test_data_rate_limit=$i --defaults.interactors_evaluation_policy=LimitedInteraction&
