...
test_observed_ui = (dsf.test_consumption_matrix.tocoo().row,
                    dsf.test_consumption_matrix.tocoo().col)
test_ground_truth = dsf.test_consumption_matrix.data

train_observed_ui = (dsf.train_consumption_matrix.tocoo().row,
                     dsf.train_consumption_matrix.tocoo().col)
