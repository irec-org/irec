...
def main():
    ...
    if args.b == None:
        ...
        datasets_preprocessors = [
            datasets_preprocessors[base] for base in args.b
        ]
    for dataset_preprocessor in datasets_preprocessors:
        ...
        users_negative_items = {
            uid: list(map(str, list(all_items - items)))
            for uid, items in users_consumed_items.items()
        }
        ...
        with open('{}.test.negative'.format(dataset_preprocessor['name']),
            ...
            for i in range(len(data)):
                uid = int(data[i, 0])
                sampled_negative_items = random.sample(
                    users_negative_items[uid], 99)
                f.write('({},{})\t{}\n'.format(
