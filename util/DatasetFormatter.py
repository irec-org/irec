...
"""
# dir trains:
Train-Test_Good-Books/
    trainSet_Good-Books_-1_bin=False_.data
    testSet_Good-Books_-1_bin=False_.data

Train-Test_Amazon-Kindle-Store/
    trainSet_Amazon-Kindle-Store_-1_bin=False_.data
    testSet_Amazon-Kindle-Store_-1_bin=False_.data

Train-Test_Ciao-DVD/
    trainSet_Ciao-DVD_-1_bin=False_.data
    testSet_Ciao-DVD_-1_bin=False_.data

Train-Test_ML-10M/
    trainSet_ML-10M_-1_bin=False_.data
    testSet_ML-10M_-1_bin=False_.data

"""
# 1ª mudar o nome do arquivo de recomendação no egreedy
# 2ª mudar BASE_DIRS tr_te_base juntamente com o diretorio
# 3ª mudar BASE_HANDLERS tr_te_base
# 4ª mudar PARAMETRO base='tr_te_base'
# 5ª mudar o nome dos arquivos de treino e teste na função get_tr_te_ml_1m'
...
class DatasetFormatter(Saveable):
    ...
    BASES_DIRS = {'ml_100k':'ml-100k/',
                  ...
                  'tr_te_netflix': '../../OLD/ActiveLearning/train_tests/Train-Test_Netflix/'}
